...
def get_few_shot_postgresql_chain():
    ...
    database_url = os.environ.get("DEV_DATABASE_URI", "postgresql://hrstreamline_render_user:XLRgIH2Cirlc1FtlsoXsRzAx0UCPzzwc@dpg-d19pp495pdvs73a1tm40-a.oregon-postgres.render.com/hrstreamline_render")
